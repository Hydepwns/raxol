  ...
  def view(state) do
    UI.box id: state.id, border: :rounded, padding: 1 do
      UI.column do
        [
          UI.label("Username:"),
          UI.text_input(id: :username_input, value: state.form_data.username, on_change: {:input, :username}),
          UI.label("Password:"),
          UI.text_input(id: :password_input, value: state.form_data.password, on_change: {:input, :password}, is_password: true),
          UI.button(label: "Submit", on_click: :submit),
