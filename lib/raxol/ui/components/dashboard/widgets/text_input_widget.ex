# Temporarily commenting out entire module due to persistent compilation error
...
#    Logger.debug("TextInputWidget received message: #{inspect msg}")
#    {state, []}
#  end
#
#  @impl Raxol.UI.Components.Base.Component
...
#    Logger.debug("TextInputWidget received event: #{inspect event}")
#    {state, []}
#  end
#
#  @doc """
