defmodule Raxol.UI.Components.Input.MultiLineInput.TextOperations.Selection do
  ...
  def normalize_positions({start_row, start_col}, {end_row, end_col}) do
    # Don't swap positions - let the calling modules handle reversed positions
    # This allows for more flexible behavior in different contexts
  ...
  defp extract_multi_line_selection(
         lines_list,
         start_row,
         start_col,
         end_row,
