defmodule Raxol.UI.Components.Modal.Core do
  ...
  @spec handle_cancel(map(), any()) :: {map(), list()}
  ...
  @spec handle_button_click(map(), any()) :: {map(), list()}
  ...
  @spec handle_unknown_message(map(), any()) :: {map(), list()}
