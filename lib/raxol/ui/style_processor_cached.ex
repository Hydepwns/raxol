defmodule Raxol.UI.StyleProcessorCached do
  ...
  def flatten_merged_style(parent_style, child_element, theme) do
    ...
    case get_cached_flattened_style(cache_key) do
      ...
      :miss ->
        ...
        flattened = compute_flattened_style_cached(parent_style, child_element, theme)
  ...
  def merge_styles_for_inheritance(parent_style, child_style) do
    ...
    case get_cached_merged_style(cache_key) do
      ...
      :miss ->
        merged = StyleProcessor.merge_styles_for_inheritance(parent_style, child_style)
  ...
  def inherit_colors(child_style_map, parent_element, parent_style_map) do
    cache_key = {:color_inherit, 
                 hash_style(child_style_map),
                 hash_style(parent_element), 
    ...
    case get_cached_colors(cache_key) do
      ...
      :miss ->
        colors = StyleProcessor.inherit_colors(child_style_map, parent_element, parent_style_map)
  ...
  defp compute_flattened_style_cached(parent_style, child_element, theme) do
    ...
    resolved_fg = ThemeResolverCached.resolve_fg_color(all_attrs, component_styles, theme)
    resolved_bg = ThemeResolverCached.resolve_bg_color(all_attrs, component_styles, theme)
  ...
  defp build_flatten_cache_key(parent_style, child_element, theme) do
    {:flatten,
     hash_style(parent_style),
     hash_element(child_element),
     get_theme_id(theme)}
  end
  ...
  defp hash_style(style) when is_map(style) do
    ...
    relevant_keys = [:style, :foreground, :background, :fg, :bg, 
