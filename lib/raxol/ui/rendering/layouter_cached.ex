defmodule Raxol.UI.Rendering.LayouterCached do
  ...
  def layout_tree(diff_result, new_tree_for_reference, constraints \\ %{}) do
    ...
    cache_key =
      generate_cache_key(diff_result, new_tree_for_reference, constraints)
    ...
    case ETSCacheManager.get_layout(cache_key.tree_hash, cache_key.constraints) do
      ...
      :miss ->
        ...
        result =
          Telemetry.layout_calculation(cache_key.tree_hash, constraints, fn ->
  ...
  def warm_cache do
    ...
    Logger.info(
      "Layout cache warmed with #{length(common_layouts)} common configurations"
    )
  end
