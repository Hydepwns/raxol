defmodule Raxol.UI.ThemeResolverCached do
  ...
  def merge_themes_for_inheritance(parent_theme, child_theme) do
    cache_key =
      {:theme_merge, hash_theme(parent_theme), hash_theme(child_theme)}
  ...
  def resolve_fg_color(attrs, component_styles, theme) do
    cache_key =
      {:fg_color, hash_attrs(attrs), hash_attrs(component_styles),
       get_theme_id(theme)}
  ...
  def resolve_bg_color(attrs, component_styles, theme) do
    cache_key =
      {:bg_color, hash_attrs(attrs), hash_attrs(component_styles),
       get_theme_id(theme)}
