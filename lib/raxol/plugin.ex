defmodule Raxol.Plugin do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      @impl true
      def handle_mouse(_event, state), do: {:ok, state}
  ...
  """
  @callback init(opts :: map()) :: {:ok, state :: term()} | {:error, reason :: String.t()}

  @doc """
  Handles a plugin event.
  """
  @callback handle_event(event :: term(), state :: term()) :: {:ok, state :: term()} | {:error, reason :: String.t()}

  @doc """
  Handles input from the terminal.
  """
  @callback handle_input(input :: String.t(), state :: term()) :: {:ok, state :: term()} | {:error, reason :: String.t()}

  @doc """
  Handles output to the terminal.
  """
  @callback handle_output(output :: String.t(), state :: term()) :: {:ok, state :: term()} | {:error, reason :: String.t()}

  @doc """
  Handles mouse events.
  """
  @callback handle_mouse(event :: term(), state :: term()) :: {:ok, state :: term()} | {:error, reason :: String.t()}

  @doc """
  Handles terminal resize events.
  """
  @callback handle_resize(width :: non_neg_integer(), height :: non_neg_integer(), state :: term()) :: {:ok, state :: term()} | {:error, reason :: String.t()}
