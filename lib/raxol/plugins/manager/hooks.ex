defmodule Raxol.Plugins.Manager.Hooks do
  ...
  defp run_plugin_hook({_name, plugin}, {:ok, acc_manager, acc_results}, hook_name, args) do
    if plugin.enabled do
      module = plugin.__struct__
  ...
  defp handle_plugin_hook(module, plugin, hook_name, args, acc_manager, acc_results) do
