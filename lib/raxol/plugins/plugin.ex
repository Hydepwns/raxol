defmodule Raxol.Plugins.Plugin do
  ...
  @callback handle_input(plugin_state :: term(), input :: String.t()) :: {:ok, term()} | {:error, String.t()}
  @callback handle_output(plugin_state :: term(), output :: String.t()) :: {:ok, term()} | {:error, String.t()}
  @callback handle_mouse(plugin_state :: term(), event :: tuple()) :: {:ok, term()} | {:error, String.t()}
  @callback handle_resize(plugin_state :: term(), width :: non_neg_integer(), height :: non_neg_integer()) :: {:ok, term()} | {:error, String.t()}
