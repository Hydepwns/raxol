defmodule Raxol.Focus do
  ...
  * `direction` - Direction to move (:next, :prev, :up, :down, :left, :right)
  ...
  def move_focus(focus_state, direction)
    ...
    move_focus(
      focus_state,
      if(direction in [:down, :right], do: :next, else: :prev)
    )
  end
          ...
          %{
            ...
            focus_key:
              Map.get(
                element,
                :focus_key,
                "button-#{:erlang.unique_integer([:positive])}"
              )
          }
        ]
          ...
          %{
            ...
            focus_key:
              Map.get(
                element,
                :focus_key,
                "input-#{:erlang.unique_integer([:positive])}"
              )
          }
        ]
