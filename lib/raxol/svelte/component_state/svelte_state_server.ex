defmodule Raxol.Svelte.ComponentState.SvelteStateServer do
  @moduledoc """
  ...
  def handle_call({:set_slots, pid, slots}, _from, state) do
    ...
    slot_history =
      [history_entry | state.slot_history]
    ...
    result =
      case Raxol.Core.ErrorHandling.safe_call(fn ->
        ...
        {:error, {reason, stacktrace}} ->
          Logger.error(
            "Error in with_slots function: #{inspect(reason)}, #{inspect(stacktrace)}"
          )
  ...
  @impl true
  def handle_call(
        {:set_component_state, component_id, component_state},
        _from,
        state
      ) do
    component_states =
      Map.put(state.component_states, component_id, component_state)
