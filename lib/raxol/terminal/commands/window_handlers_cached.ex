defmodule Raxol.Terminal.Commands.WindowHandlersCached do
  ...
  @default_line_height 1.143  # Results in 16px height for 14pt font
  ...
  """
  @spec calculate_with_font(FontManager.t(), non_neg_integer(), non_neg_integer()) :: 
        %{chars: non_neg_integer(), lines: non_neg_integer()}
  def calculate_with_font(%FontManager{} = font_manager, pixel_width, pixel_height) do
