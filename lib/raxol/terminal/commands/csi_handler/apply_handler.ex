defmodule Raxol.Terminal.Commands.CSIHandler.ApplyHandlers do
  @moduledoc """
  ...
  def apply_handler(emulator, :bracketed_paste_start, _params),
    do: CSIHandler.handle_bracketed_paste_start(emulator)

  def apply_handler(emulator, :bracketed_paste_end, _params),
    do: CSIHandler.handle_bracketed_paste_end(emulator)
end
