defmodule Raxol.Architecture.CQRS.Setup do
  ...
  def setup do
    ...
    :ok = CommandDispatcher.register_handler(CloseTerminalCommand, CloseTerminalHandler)
    :ok = CommandDispatcher.register_handler(ApplyThemeCommand, ApplyThemeHandler)
