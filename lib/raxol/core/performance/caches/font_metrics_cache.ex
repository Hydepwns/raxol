defmodule Raxol.Core.Performance.Caches.FontMetricsCache do
  ...
  """
  @spec get_font_dimensions(FontManager.t()) :: {non_neg_integer(), non_neg_integer()}
  ...
  """
  @spec calculate_pixel_width(FontManager.t(), non_neg_integer()) :: non_neg_integer()
  ...
  """
  @spec calculate_pixel_height(FontManager.t(), non_neg_integer()) :: non_neg_integer()
