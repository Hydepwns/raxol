defmodule Raxol.Core.Accessibility.Behaviour do
  ...
  """
  @callback enable(options :: list(), user_preferences_pid_or_name :: atom() | pid() | nil) :: :ok
  ...
  """
  @callback high_contrast_enabled?(user_preferences_pid_or_name :: atom() | pid() | nil) :: boolean()
  ...
  """
  @callback large_text_enabled?(user_preferences_pid_or_name :: atom() | pid() | nil) :: boolean()
