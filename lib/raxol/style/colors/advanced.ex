  ...
  def create_harmony(%Color{} = color, harmony_type) do
    ...
    case harmony_type do
      :complementary ->
        [
          color,
          hsl_to_rgb(%{hsl | h: rem(hsl.h + 180, 360)})
        ]
      
      :analogous ->
        [
          color,
          hsl_to_rgb(%{hsl | h: rem(hsl.h + 30, 360)}),
          hsl_to_rgb(%{hsl | h: rem(hsl.h - 30 + 360, 360)})
        ]
      
      :triadic ->
        [
          color,
          hsl_to_rgb(%{hsl | h: rem(hsl.h + 120, 360)}),
          hsl_to_rgb(%{hsl | h: rem(hsl.h + 240, 360)})
        ]
      
      :tetradic ->
        [
          color,
          hsl_to_rgb(%{hsl | h: rem(hsl.h + 90, 360)}),
          hsl_to_rgb(%{hsl | h: rem(hsl.h + 180, 360)}),
          hsl_to_rgb(%{hsl | h: rem(hsl.h + 270, 360)})
        ]
    end
  end
