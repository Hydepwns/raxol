...
defmodule ReplaceWithRefactored do
  ...
  @replacements [
    {"lib/raxol/core/focus_manager.ex", "lib/raxol/core/focus_manager_refactored.ex"},
    {"lib/raxol/core/accessibility.ex", "lib/raxol/core/accessibility_refactored.ex"},
    {"lib/raxol/core/keyboard_navigator.ex", "lib/raxol/core/keyboard_navigator_refactored.ex"},
    {"lib/raxol/core/keyboard_shortcuts.ex", "lib/raxol/core/keyboard_shortcuts_refactored.ex"},
    {"lib/raxol/core/events/manager.ex", "lib/raxol/core/events/manager_refactored.ex"},
    {"lib/raxol/core/performance/optimizer.ex", "lib/raxol/core/performance/optimizer_refactored.ex"},
    {"lib/raxol/core/ux_refinement.ex", "lib/raxol/core/ux_refinement_refactored.ex"},
    ...
    {"lib/raxol/animation/state_manager.ex", "lib/raxol/animation/state_manager_refactored.ex"},
    {"lib/raxol/animation/gestures.ex", "lib/raxol/animation/gestures_refactored.ex"},
    {"lib/raxol/terminal/window/manager.ex", "lib/raxol/terminal/window/manager_refactored.ex"},
    {"lib/raxol/svelte/slots.ex", "lib/raxol/svelte/slots_refactored.ex"},
    {"lib/raxol/security/user_context.ex", "lib/raxol/security/user_context_refactored.ex"},
  ]
  ...
  defp analyze_replacement({target, source}) do
    cond do
      ...
      true ->
        ...
        IO.puts("✅ #{target} ← #{source} (#{source_size} bytes → #{target_size} bytes)")
    end
  end
  ...
  defp apply_replacement({target, source}) do
    cond do
      ...
      true ->
        ...
        fixed_content = String.replace(refactored_content, refactored_module, original_module)
