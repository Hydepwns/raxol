...
if config_env() == :prod do
  ...
  config :raxol, :terminal,
    ...
    virtual_scroll_size: String.to_integer(System.get_env("TERMINAL_VIRTUAL_SCROLL_SIZE") || "1000"),
    memory_limit: String.to_integer(System.get_env("TERMINAL_MEMORY_LIMIT") || "52428800"),
    cleanup_interval: String.to_integer(System.get_env("TERMINAL_CLEANUP_INTERVAL") || "60000")
  ...
  config :raxol, :web,
    ...
    font_family: System.get_env("WEB_FONT_FAMILY", "JetBrains Mono, SF Mono, monospace"),
  ...
  config :raxol, :production,
    ...
    memory_warning_threshold: String.to_integer(System.get_env("MEMORY_WARNING_THRESHOLD") || "41943040"),
    performance_sampling_rate: String.to_integer(System.get_env("PERFORMANCE_SAMPLING_RATE") || "1000")
end 