defmodule Raxol.Test.VisualizationTestData do
  ...
  def bar_chart_test_data do
    %{
      ...
      large_dataset: Enum.map(1..100, fn i ->
        %{label: "Item #{i}", value: :rand.uniform(100)}
      end),

      # Dataset with very long labels
      long_labels: [
        %{label: "This is an extremely long label that should test text truncation capabilities", value: 30},
        %{label: "Another very long label that goes beyond reasonable display width in terminals", value: 45},
  ...
  def treemap_test_data do
    %{
      ...
      normal: %{
        ...
        value: 100,
        children: [
          %{name: "Group A", value: 40, children: [
            %{name: "A1", value: 25},
            %{name: "A2", value: 15}
          ]},
          %{name: "Group B", value: 60, children: [
            %{name: "B1", value: 30},
            %{name: "B2", value: 30}
          ]}
        ]
      ...
      deep_nesting: %{
        ...
        value: 100,
        children: [
          %{name: "Level 2", value: 100, children: [
            %{name: "Level 3", value: 100, children: [
              %{name: "Level 4", value: 100, children: [
                %{name: "Level 5", value: 100, children: [
      ...
      unicode_names: %{
        ...
        value: 100,
        children: [
          %{name: "🌎 Americas", value: 40, children: [
            %{name: "🇺🇸 USA", value: 25},
            %{name: "🇨🇦 Canada", value: 15}
          ]},
          %{name: "🌏 Asia", value: 60, children: [
            %{name: "🇯🇵 Japan", value: 30},
            %{name: "🇨🇳 China", value: 30}
          ]}
        ]
      ...
      complex_mixed: %{
        ...
        value: 5000,
        children: [
          %{name: "Engineering", value: 2000, children: [
            %{name: "Frontend", value: 600, children: [
              %{name: "React", value: 400},
              %{name: "Vue", value: 200}
            ]},
            %{name: "Backend", value: 800, children: [
              %{name: "Java", value: 400},
          ...
          %{name: "Marketing", value: 1000, children: [
            %{name: "Digital", value: 600},
            %{name: "Print", value: 400}
          ]},
          %{name: "Sales", value: 1500, children: [
  ...
  def size_adaptive_test_data(width, height) do
    ...
    bar_data = Enum.map(1..num_bars, fn i ->
      %{label: "Item #{i}", value: :rand.uniform(100)}
    end)
  ...
  defp build_nested_tree(name, depth, branching) do
    children = Enum.map(1..branching, fn i ->
    ...
    total_value = Enum.reduce(children, 0, fn child, acc ->
