defmodule Raxol.Terminal.ANSI.WindowManipulationTest do
  ...
  describe "process_sequence/2" do
    test "handles window move operation" do
      state = WindowManipulation.new()
      {new_state, response} = WindowManipulation.process_sequence(state, "\e[3;10t")
    ...
    test "handles window resize operation" do
      state = WindowManipulation.new()
      {new_state, response} = WindowManipulation.process_sequence(state, "\e[8;30;100t")
    ...
    test "handles window maximize operation" do
      state = WindowManipulation.new()
      {new_state, response} = WindowManipulation.process_sequence(state, "\e[1;1t")
    ...
    test "handles window restore operation" do
      ...
      {new_state, response} = WindowManipulation.process_sequence(state, "\e[1;0t")
    ...
    test "handles window raise operation" do
      state = WindowManipulation.new()
      {new_state, response} = WindowManipulation.process_sequence(state, "\e[5t")
    ...
    test "handles window lower operation" do
      state = WindowManipulation.new()
      {new_state, response} = WindowManipulation.process_sequence(state, "\e[6t")
    ...
    test "handles window title setting" do
      state = WindowManipulation.new()
      {new_state, response} = WindowManipulation.process_sequence(state, "\e]0;New Title\a")
    ...
    test "handles window icon setting" do
      state = WindowManipulation.new()
      {new_state, response} = WindowManipulation.process_sequence(state, "\e]1;New Icon\a")
    ...
    test "handles window query operation" do
      ...
      {new_state, response} = WindowManipulation.process_sequence(state, "\e[13t")
    ...
    test "handles invalid sequence" do
      state = WindowManipulation.new()
      {new_state, response} = WindowManipulation.process_sequence(state, "\e[invalid")
  ...
  describe "parse_sequence/1" do
    ...
    test "parses window resize sequence" do
      assert {:ok, :resize, [30, 100]} = WindowManipulation.parse_sequence("8;30;100t")
    end
