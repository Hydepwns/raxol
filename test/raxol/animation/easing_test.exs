defmodule Raxol.Animation.EasingTest do
  ...
  describe "Easing Functions" do
    ...
    test "quadratic ease-in-out" do
      ...
      t = 0.6 # Test above 0.5
      assert Easing.calculate_value(:ease_in_out_quad, t) == -1 + (4 - 2 * t) * t
    end
    ...
    test "cubic ease-out" do
      ...
      t_minus_1 = t - 1
      assert Easing.calculate_value(:ease_out_cubic, t) == t_minus_1 * t_minus_1 * t_minus_1 + 1
    end
    ...
    test "cubic ease-in-out" do
      ...
      t = 0.6 # Test above 0.5
      t_minus_1 = t - 1
      assert Easing.calculate_value(:ease_in_out_cubic, t) == (t - 1) * (2 * t_minus_1 * t_minus_1) + 1
    end
    ...
    test "elastic ease-in-out" do
      ...
      assert_in_delta Easing.calculate_value(:ease_in_out_elastic, t), 1.011, 0.001
    end
    ...
    test "standard ease-in" do
      ...
      assert Easing.calculate_value(:ease_in, t) == t * t # Defaults to quad
    end
    ...
    test "standard ease-out" do
      ...
      # Update assertion based on actual default implementation if different
      assert Easing.calculate_value(:ease_out, t) == t * (2 - t) # Defaults to quad
    end
    ...
    test "standard ease-in-out" do
      ...
      # Update assertion based on actual default implementation if different
      assert Easing.calculate_value(:ease_in_out, t) == 2 * t * t # Defaults to quad
    end
