defmodule Raxol.Core.Events.ManagerTest do
  ...
  describe "register_handler/3" do
    test "registers a handler for an event type" do
      # Register a handler
      assert :ok = EventManager.register_handler(:test_event, __MODULE__, :dummy_handler)
  ...
  describe "unregister_handler/3" do
    test "unregisters a handler" do
      ...
      assert :ok = EventManager.unregister_handler(:test_event, __MODULE__, :dummy_handler)
    ...
    test "does nothing for unregistered handler" do
      ...
      assert :ok = EventManager.unregister_handler(:test_event, __MODULE__, :nonexistent_handler)
    end
  end
  ...
  describe "dispatch/1" do
    test "dispatches event to registered handlers" do
      ...
      # Register handler
      EventManager.register_handler(:test_event, TestHandler, :handle_test_event)
    ...
    test "dispatches atom events" do
      ...
      # Register handler
      EventManager.register_handler(:atom_event, AtomEventHandler, :handle_atom_event)
  ...
  describe "clear_handlers/0" do
    test "clears all handlers" do
      ...
      EventManager.register_handler(:test_event, __MODULE__, :dummy_handler)
      EventManager.register_handler(:another_event, __MODULE__, :another_handler)
