defmodule Raxol.Core.Runtime.Plugins.VersionConstraintTest do
  ...
  describe "version constraint handling" do
    ...
    test "handles invalid version formats" do
      ...
      assert {:error, :version_mismatch, [{"other_plugin", "1.0.0", "invalid_version"}], ["my_plugin"]} ==
               DependencyManager.check_dependencies("my_plugin", plugin_metadata, loaded_plugins)
    end

    test "handles invalid version requirement formats" do
      plugin_metadata = %{dependencies: [{"other_plugin", ">= 1.0.0 || invalid"}]}
      loaded_plugins = %{"other_plugin" => %{version: "1.0.0"}}

      assert {:error, :version_mismatch, [{"other_plugin", "1.0.0", ">= 1.0.0 || invalid"}], ["my_plugin"]} ==
               DependencyManager.check_dependencies("my_plugin", plugin_metadata, loaded_plugins)
    end
    ...
    test "handles missing version in loaded plugins" do
      ...
      loaded_plugins = %{"plugin_a" => %{}}  # Missing version field
