defmodule Raxol.Core.KeyboardShortcutsTest do
  ...
  describe "register_shortcut/4" do
    test "registers global shortcut" do
      ...
      assert :ok = KeyboardShortcuts.register_shortcut("Ctrl+S", :save, callback, 
    ...
    test "registers context-specific shortcut" do
      ...
      assert :ok = KeyboardShortcuts.register_shortcut("Alt+F", :file_menu, fn -> nil end, 
                                                     context: :main_menu,
    ...
    test "handles complex key combinations" do
      ...
      assert :ok = KeyboardShortcuts.register_shortcut("Ctrl+Shift+Alt+X", :complex, fn -> nil end)
  ...
  describe "unregister_shortcut/2" do
    ...
    test "unregisters context-specific shortcut" do
      # Register a context-specific shortcut
      KeyboardShortcuts.register_shortcut("Alt+F", :file_menu, fn -> nil end, context: :main_menu)
  ...
  describe "get_shortcuts_for_context/1" do
    test "gets global shortcuts" do
      ...
      KeyboardShortcuts.register_shortcut("Ctrl+S", :save, fn -> nil end, description: "Save document")
      KeyboardShortcuts.register_shortcut("Ctrl+O", :open, fn -> nil end, description: "Open document")
    ...
    test "gets context-specific shortcuts" do
      ...
      KeyboardShortcuts.register_shortcut("Alt+E", :edit_menu, fn -> nil end, 
                                         context: :main_menu, description: "Open edit menu")
      ...
      file_menu_shortcut = Enum.find(shortcuts, fn s -> s.name == :file_menu end)
      assert file_menu_shortcut != nil
      assert file_menu_shortcut.key_combo == "Alt+F"
      
      edit_menu_shortcut = Enum.find(shortcuts, fn s -> s.name == :edit_menu end)
  ...
  describe "show_shortcuts_help/0" do
    test "generates help message for shortcuts" do
      ...
      assert String.contains?(help_message, "Available keyboard shortcuts for Global")
  ...
  describe "trigger_shortcut/2" do
    ...
    test "returns error for non-existent shortcut" do
      ...
      assert {:error, :shortcut_not_found} = KeyboardShortcuts.trigger_shortcut(:nonexistent)
    end
    ...
    test "finds shortcut in specified context" do
      ...
      # Register a context-specific shortcut
      KeyboardShortcuts.register_shortcut("Alt+F", :file_menu, fn -> 
        send(test_pid, :file_menu_triggered)
      end, context: :main_menu)
  ...
  describe "handle_keyboard_event/1" do
    ...
    test "respects priority order for shortcuts" do
      ...
      KeyboardShortcuts.register_shortcut("Ctrl+P", :print_low, fn -> 
        send(test_pid, :print_low_triggered)
      end, priority: :low)
      
      # Register high priority shortcut with same key combo
      KeyboardShortcuts.register_shortcut("Ctrl+P", :print_high, fn -> 
        send(test_pid, :print_high_triggered)
      end, priority: :high, context: :editor)
