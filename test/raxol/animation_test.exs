defmodule Raxol.AnimationTest do
  ...
  describe "Animation Framework with accessibility integration" do
    test "respects reduced motion settings" do
      ...
      standard_animation = Framework.create_animation(
        duration: 500,
        easing: :ease_in_out,
        from: 0,
        to: 100
      ...
      reduced_motion_animation = Framework.create_animation(
        duration: 500,
        easing: :ease_in_out,
        from: 0,
        to: 100
    ...
    test "announces animation start and completion to screen readers when relevant" do
      with_screen_reader_spy fn ->
        ...
        animation = Framework.create_animation(
          duration: 100,
          from: 0,
          to: 100,
    ...
    test "animations have appropriate timing for cognitive accessibility" do
      ...
      cognitive_animation = Framework.create_animation(
        duration: 500,
        from: 0,
        to: 100
      )
