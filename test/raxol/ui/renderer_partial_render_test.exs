defmodule Raxol.UI.RendererPartialRenderTest do
  ...
  test ~c"partial render updates buffer for label text change" do
  ...
  test ~c"partial render updates buffer for multiple labels on different lines" do
    tree = %{
      type: :view,
      children: [
  ...
  test ~c"partial render updates buffer for nested label" do
    tree = %{
      type: :view,
      children: [
        %{
  ...
  test ~c"partial render updates buffer for multiple labels, non-zero index" do
    tree = %{
      type: :view,
      children: [
  ...
  test ~c"partial render updates buffer for deeply nested label" do
    tree = %{
      type: :view,
      children: [
        %{
  ...
  test ~c"partial render updates buffer for sibling views with multiple children" do
    tree = %{
      type: :view,
      children: [
        %{
  ...
  test ~c"partial render ignores unknown node types and only renders labels" do
    tree = %{
      type: :view,
      children: [
  ...
  test ~c"partial render updates buffer for wide tree with many labels" do
  ...
  test ~c"partial render updates buffer for multiple updates in one diff" do
    tree = %{
      type: :view,
      children: [
        %{type: :label, attrs: %{text: "A"}},
