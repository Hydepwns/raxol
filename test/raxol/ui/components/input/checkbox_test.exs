defmodule Raxol.UI.Components.Input.CheckboxTest do
  ...
  describe "init/1" do
    test ~c"initializes with default values" do
    ...
    test ~c"initializes with provided props" do
  ...
  describe "render/1" do
    ...
    test ~c"renders unchecked checkbox" do
    ...
    test ~c"renders checked checkbox" do
    ...
    test ~c"renders disabled checkbox with disabled style" do
  ...
  describe "update/2" do
    test ~c"updates the checked state" do
    ...
    test ~c"updates the disabled state" do
    ...
    test ~c"updates the on_toggle callback" do
  ...
  describe "handle_event/3" do
    ...
    test ~c"toggles state from unchecked to checked on click" do
    ...
    test ~c"toggles state from checked to unchecked on click" do
    ...
    test ~c"toggles state from unchecked to checked on space keypress" do
      state = init_state(checked: false)
    ...
    test ~c"toggles state from checked to unchecked on space keypress" do
      state = init_state(checked: true)
    ...
    test ~c"does not toggle state on other keypress" do
      state = init_state(checked: false)
    ...
    test ~c"does not toggle when disabled (click)" do
    ...
    test ~c"does not toggle when disabled (space keypress)" do
      state = init_state(checked: false, disabled: true)
    ...
    test ~c"calls on_toggle callback with new state when toggled" do
    ...
    test ~c"does not call on_toggle callback when not toggled" do
      # Use Process dictionary to track if callback was called
