defmodule Raxol.UI.Components.Base.LifecycleTest do
  ...
  describe "component lifecycle" do
    test ~c"mount adds event to lifecycle" do
    ...
    test ~c"unmount adds event to lifecycle" do
      component = TestComponent.new()
    ...
    test ~c"render increases render count" do
      component = TestComponent.new()
    ...
    test ~c"update correctly merges props" do
  ...
  describe "event handling" do
    test ~c"handle_event with update returns updated component" do
      component = TestComponent.new(value: "initial")
    ...
    test ~c"handle_event with handled returns same component" do
      component = TestComponent.new()
    ...
    test ~c"handle_event with passthrough returns passthrough" do
      component = TestComponent.new()
      event = %{type: :unknown}
    ...
    test ~c"multiple event handling updates counters correctly" do
      component = TestComponent.new(value: "initial")
  ...
  describe "complete lifecycle flow" do
    test ~c"full component lifecycle" do
      # Create and mount
