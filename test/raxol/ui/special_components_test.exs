defmodule Raxol.UI.SpecialComponentsTest do
  ...
  test ~c"handles tables with varying row lengths" do
  ...
  test ~c"handles tables with empty data" do
    headers = ["Name", "Age", "City"]
    data = []
    element = Helper.create_test_table(0, 0, headers, data)
    cells = Renderer.render_to_cells(element)
  ...
  test ~c"handles tables with empty headers" do
    headers = []
  ...
  test ~c"handles tables with very long content" do
  ...
  test ~c"handles tables with special characters" do
    headers = ["Name", "Symbol"]
  ...
  test ~c"handles tables with custom column widths" do
    headers = ["Name", "Age", "City"]
    data = [["John", "25", "New York"]]
  ...
  test ~c"handles tables with custom styles" do
    headers = ["Name", "Age"]
    data = [["John", "25"]]
  ...
  test ~c"handles tables with sorting" do
    headers = ["Name", "Age"]
