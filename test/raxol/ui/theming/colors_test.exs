defmodule Raxol.UI.Theming.ColorsTest do
  ...
  describe "to_rgb/1" do
    test ~c"converts hex colors to RGB" do
    ...
    test ~c"converts named colors to RGB" do
  ...
  describe "to_hex/1" do
    test ~c"converts RGB to hex colors" do
    ...
    test ~c"converts RGBA to hex colors" do
  ...
  describe "lighten/2" do
    test ~c"lightens colors by percentage" do
  ...
  describe "darken/2" do
    test ~c"darkens colors by percentage" do
    ...
    test ~c"darkens named colors" do
  ...
  describe "contrast_ratio/2" do
    test ~c"calculates contrast ratio between colors" do
    ...
    test ~c"works with named colors" do
  ...
  describe "accessible?/4" do
    test ~c"checks WCAG AA accessibility for normal text" do
    ...
    test ~c"checks WCAG AA accessibility for large text" do
    ...
    test ~c"checks WCAG AAA accessibility for normal text" do
  ...
  describe "blend/3" do
    test ~c"blends two colors with alpha" do
