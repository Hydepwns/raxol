defmodule Raxol.UI.RendererTestHelper do
  ...
  def assert_cell_style(cell, expected_fg, expected_bg, expected_style_attrs \\ []) do
    assert cell != nil
  ...
  def create_test_box(x, y, width, height, opts \\ %{}) do
    create_test_element(:box, x, y, Map.merge(%{width: width, height: height}, opts))
  end
  ...
  def create_test_panel(x, y, width, height, children \\ [], opts \\ %{}) do
    create_test_element(:panel, x, y, Map.merge(%{
      width: width,
      height: height,
      children: children
    }, opts))
  ...
  def create_test_table(x, y, headers, data, opts \\ %{}) do
    create_test_element(:table, x, y, Map.merge(%{
      headers: headers,
      data: data
    }, opts))
  end
