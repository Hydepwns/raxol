defmodule Raxol.Style.Colors.GradientTest do
  ...
  describe "linear/3" do
    test "creates a linear gradient with the correct number of steps" do
      ...
      assert hd(gradient.colors).hex == "#FF0000"  # First color is red
      assert List.last(gradient.colors).hex == "#0000FF"  # Last color is blue
    end
  ...
  describe "multi_stop/2" do
    ...
    test "handles uneven distribution of steps" do
      ...
      steps = 5  # Not evenly divisible by (colors - 1)
  ...
  describe "reverse/1" do
    test "reverses the order of colors in the gradient" do
      ...
      assert hd(reversed.colors).hex == "#0000FF"  # First color is now blue
      assert List.last(reversed.colors).hex == "#FF0000"  # Last color is now red
