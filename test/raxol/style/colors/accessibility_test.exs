...
#       # Gray on Gray
#       assert {:error, {:contrast_too_low, ratio, _}} = Accessibility.check_contrast("#777777", "#999999")
#       assert ratio < 4.5
#     end
#
...
#       assert {:error, _} = Accessibility.check_contrast("#767676", "#FFFFFF", :aaa)
...
#       assert suggested_lum < original_lum
...
#       colors = %{
#         text: "#000000",
#         link: "#0066CC" # Accessible link color on white
#       }
...
#       colors = %{
#         text: "#777777", # Low contrast text on white
#         link: "#999999" # Low contrast link on white
#       }
...
#       assert {:ok, _} = Accessibility.validate_colors(Map.drop(adjusted, [:background]), adjusted.background)
#       # Check that colors were actually changed
#       refute adjusted.text == colors.text
#       refute adjusted.link == colors.link
#     end
#   end
#
