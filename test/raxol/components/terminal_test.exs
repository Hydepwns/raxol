defmodule Raxol.UI.Components.TerminalTest do
  ...
  describe "Terminal component" do
    ...
    test "renders visible portion of buffer" do
      ...
      assert rendered.id == terminal.id
      assert rendered.width == terminal.width
      assert rendered.height == terminal.height
      assert rendered.style == terminal.style
      ...
      assert label1.content == "Line 1"
      assert label2.type == :label
      assert label2.content == "Line 2"
    end
  end
end
