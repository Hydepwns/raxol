defmodule Raxol.Terminal.CellTest do
  ...
  describe "has_attribute?/2" do
    test "checks if a cell has a specific attribute" do
      cell = Cell.new("A")
      cell = Cell.set_style(cell, TextFormatting.set_attribute(TextFormatting.new(), :bold))
      assert Cell.has_attribute?(cell, :bold)
  ...
  describe "has_decoration?/2" do
    test "checks if a cell has a specific decoration" do
      cell = Cell.new("A")
      cell = Cell.set_style(cell, TextFormatting.set_decoration(TextFormatting.new(), :underline))
  ...
  describe "double_width?/1" do
    test "checks if a cell is in double-width mode" do
      cell = Cell.new("A")
      cell = Cell.set_style(cell, TextFormatting.set_double_width(TextFormatting.new(), true))
      assert Cell.double_width?(cell)
      
      cell = Cell.set_style(cell, TextFormatting.set_double_width(TextFormatting.new(), false))
  ...
  describe "double_height?/1" do
    test "checks if a cell is in double-height mode" do
      cell = Cell.new("A")
      cell = Cell.set_style(cell, TextFormatting.set_double_height(TextFormatting.new(), true))
      assert Cell.double_height?(cell)
      
      cell = Cell.set_style(cell, TextFormatting.set_double_height(TextFormatting.new(), false))
