defmodule Raxol.Performance.TextWrappingCacheTest do
  ...
  describe "performance" do
    test "cached wrapping is faster than calculating widths repeatedly" do
      long_text = String.duplicate("The quick brown fox jumps over the lazy dog. ", 20)
      ...
      new_text = String.duplicate("Different text that hasn't been cached yet. ", 20)
