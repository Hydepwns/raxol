...
# Note: PresenceIntegrationTest was removed as it contained only empty stub tests.
# Integration tests requiring full Phoenix PubSub should be implemented when needed.
