defmodule RaxolPlaygroundWeb.GalleryLive do
  ...
  Displays all 23 widgets with filtering by category and complexity.
  """
            ...
            <div class="flex items-center space-x-2">
              ...
              <div class="flex flex-wrap gap-2">
                <button
                  ...
                  class={"px-3 py-1 rounded-full text-sm #{if @active_category == nil, do: "bg-blue-100 text-blue-800", else: "bg-gray-100 text-gray-700 hover:bg-gray-200"}"}
                >
                  All
                </button>
                <%= for cat <- @categories do %>
                  <button
                    ...
                    class={"px-3 py-1 rounded-full text-sm #{if @active_category == cat, do: "bg-blue-100 text-blue-800", else: "bg-gray-100 text-gray-700 hover:bg-gray-200"}"}
                  >
      ...
      <div class="p-4">
        ...
        <div class="flex space-x-2">
          <a
            ...
            class="flex-1 px-3 py-2 bg-blue-600 text-white text-sm text-center rounded hover:bg-blue-700 transition-colors"
          >
            Try Live
          </a>
          <a
