...
defmodule ShowcaseApp do
  ...
  import Raxol.Examples.ComponentShowcase # Needed if using <.component_showcase /> syntax, requires ComponentShowcase to `use Surface.Component` or similar

  @impl Raxol.Core.Runtime.Application
  def init(_opts) do
    # No specific state needed for this simple wrapper
    initial_model = %{}
    {:ok, initial_model, []} # Return initial model and empty command list
  end
