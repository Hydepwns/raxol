...
Version 1.2.0 represents a major stabilization release focusing on resolving critical API issues, implementing comprehensive code organization tools, and strengthening the overall reliability of the Raxol terminal application framework.
...
**Three-Tool Approach:**
1. **Standalone Script** (`scripts/check_duplicate_filenames.exs`)
