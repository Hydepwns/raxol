defmodule Raxol.Symphony.Test.EtsTables do
  ...
  Deliberately a copy of `Raxol.Agent.Test.EtsTables`: raxol_agent is an
  optional dependency here and its `test/support` is not shipped. Keep the two
  `drop/1` bodies identical.
  """
