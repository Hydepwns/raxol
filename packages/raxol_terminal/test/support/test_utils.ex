defmodule Raxol.Test.TestUtils do
  ...
  def setup_rendering_test do
    ...
    {:ok, timer_server_pid} =
      start_supervised({Raxol.UI.Rendering.TimerServer, name: Raxol.UI.Rendering.TimerServer})

    # Start the Renderer GenServer with module name registration
    {:ok, renderer_pid} =
      start_supervised({Raxol.UI.Rendering.Renderer, name: Raxol.UI.Rendering.Renderer})
